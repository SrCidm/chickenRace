...
def create_players(colors):
    """
    Crea y configura las gallinas para la carrera.
    """
    turtles = []
    spacingx = WIDTH // (len(colors) + 1)  # Ajustar el espaciado
    ...
    for i, color in enumerate(colors):
        ...
        # Ajustar la posición inicial para que todas las gallinas quepan en la pantalla
        racer.goto(-WIDTH // 2 + (i + 1) * spacingx, -HEIGHT // 2 + 50)
...
def main():
    ...
    # Seleccionar colores aleatorios para las gallinas
